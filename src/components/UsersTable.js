...
const unBlockingTimeInMilliseconds = unBlockingTimeInMinutes * 60 * 1000;
...
const handleTopUserClick = (event, user, setUsers, setTopUsers) => {
  let topUsersIds = localStorage.getItem("topUsersIds");
        ...
        return (
          <tr key={index}>
            ...
            <td>
              <Toggle
                username={username}
                handleBlockToggle={() => handleBlockToggle(setBlockedUsers)}
              />
